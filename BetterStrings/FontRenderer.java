package net.texclient.gui.util;
...
public FontRenderer(String fontName, int fontType, int size) {
        this(fontName, fontType, size, 0);
}

public FontRenderer(String fontName, int fontType, int size, float kerning) {
