...
public class Font {
    ...
    public Font(ResourceLocation resourceLocation, float size) {
        ...
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(resourceLocation)
                    .getInputStream();
            tmp = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, is).deriveFont(size);
        } catch (IOException | FontFormatException e) {
            tmp = new java.awt.Font("Arial", java.awt.Font.PLAIN, (int) size);
            e.printStackTrace();
        }
    ...
    private BufferedImage generateFontImage(java.awt.Font font, boolean antiAlias, boolean fractionalMetrics,
                                            CharData[] chars) {
